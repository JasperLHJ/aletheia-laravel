...
const page = usePage();
const site = computed(() => page.props.siteContent ?? {});

const navLinks = computed(() => site.value.nav?.links ?? []);
const legalLinks = computed(() => site.value.footer?.legal ?? []);
const enquiryHref = computed(() => site.value.enquiryAnchor ?? '#enquiry');
    ...
    <div class="min-h-screen bg-purple-gray-50 font-sans">
        ...
        >
            <nav
                ...
                :aria-label="site.nav?.ariaLabel ?? 'Main navigation'"
            >
                <a
                    href="/"
        ...
        <footer class="bg-purple-gray-950 text-white/70" role="contentinfo">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div>
                        <h3 class="text-xs font-sans font-medium text-white/40 uppercase tracking-widest mb-4">{{ site.footer?.quickLinksHeading }}</h3>
                    ...
                    <div>
                        <h3 class="text-xs font-sans font-medium text-white/40 uppercase tracking-widest mb-4">{{ site.footer?.connectHeading }}</h3>
                        ...
                        <div class="flex items-center gap-3">
                            <a
                                v-for="(soc, i) in (site.footer?.social ?? [])"
                                :key="i"
                                :href="soc.href"
                                target="_blank"
                            ...
                            >
                                ...
                                <svg v-else-if="i === 1" class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a
            :href="site.floatingWhatsapp?.href"
            target="_blank"
            rel="noopener noreferrer"
            ...
            :aria-label="site.floatingWhatsapp?.ariaLabel"
        >
