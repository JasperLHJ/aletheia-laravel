        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="mt-3 text-neutral-600 text-sm sm:text-base max-w-lg mx-auto leading-relaxed">
                    We welcome prospective families to tour our campus. Come see where learning comes to life.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div class="visit-info-card flex flex-col items-start p-7 rounded-2xl bg-white border border-neutral-200 shadow-sm">
                    ...
                    <h3 class="font-display font-semibold text-espresso text-lg mb-3">Our Address</h3>
                    <address class="not-italic text-neutral-600 text-sm leading-relaxed">
                        <p class="font-medium text-neutral-700">Aletheia Resource Center</p>
                        <p>No. 12, Jalan Pendidikan 3/4</p>
                        <p>Taman Ilmu, 50480</p>
                ...
                <div class="visit-info-card flex flex-col items-start p-7 rounded-2xl bg-white border border-neutral-200 shadow-sm">
                    ...
                    <h3 class="font-display font-semibold text-espresso text-lg mb-3">Office Hours</h3>
                    <dl class="w-full text-sm space-y-2">
                        <div class="flex justify-between items-center py-1.5 border-b border-neutral-100">
                            <dt class="text-neutral-500">Monday – Friday</dt>
                            <dd class="font-medium text-neutral-700">7:30 am – 4:30 pm</dd>
                        </div>
                        <div class="flex justify-between items-center py-1.5 border-b border-neutral-100">
                            <dt class="text-neutral-500">Saturday</dt>
                            <dd class="font-medium text-neutral-700">8:00 am – 12:00 pm</dd>
                        </div>
                        <div class="flex justify-between items-center py-1.5">
                            <dt class="text-neutral-500">Sunday & Public Holidays</dt>
                            <dd class="font-medium text-neutral-400 italic">Closed</dd>
                        </div>
                    </dl>
                    <p class="mt-4 text-xs text-neutral-400 leading-relaxed">
                        WhatsApp enquiries are monitored during office hours.
                    </p>
                </div>
                ...
                <div class="visit-info-card flex flex-col items-start p-7 rounded-2xl bg-white border border-neutral-200 shadow-sm">
                    ...
                    <h3 class="font-display font-semibold text-espresso text-lg mb-3">Follow Us</h3>
                    <p class="text-neutral-600 text-sm leading-relaxed mb-5">
                        Stay connected for school updates, events, and student life highlights.
                    </p>
                    <div class="flex flex-col gap-3 w-full">
                        ...
                        <a
                            ...
                            rel="noopener noreferrer"
                            class="flex items-center gap-3 text-sm text-neutral-600 hover:text-espresso transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-crimson rounded-sm"
                            aria-label="WhatsApp Aletheia Resource Center"
                        >
                            <span class="flex items-center justify-center w-8 h-8 rounded-full bg-neutral-100 group-hover:bg-[#25D366] group-hover:text-white transition-all duration-200">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
