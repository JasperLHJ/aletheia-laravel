            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div class="relative mb-6 flex items-center justify-center">
                        <div
                            ...
                            style="background: #25D366; transform: scale(1.5); filter: blur(12px);"
                            aria-hidden="true"
                        ></div>
                        <div class="relative z-10 flex items-center justify-center w-16 h-16 rounded-full" style="background-color: #25D366;">
                ...
                >
                    <div class="relative mb-6 flex items-center justify-center">
                        <div
                            class="absolute inset-0 rounded-full opacity-20 group-hover:opacity-40 transition-opacity"
                            style="background: #D30C5F; transform: scale(1.5); filter: blur(12px);"
                            aria-hidden="true"
                        ></div>
                        <div class="relative z-10 flex items-center justify-center w-16 h-16 rounded-full bg-crimson">
