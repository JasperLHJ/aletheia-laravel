            ...
            <div class="flex flex-wrap items-center gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-slate-600 dark:text-slate-400">
                        Body is rendered as HTML on the public site (e.g. <code class="text-xs">&lt;p&gt;</code>, <code class="text-xs">&lt;blockquote&gt;</code>).
                    </p>
                </div>
            </div>
        </template>
                ...
                <Card>
                    <template #content>
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div>
                                <InputLabel for="slug" value="Slug (optional — generated from title)" />
                                <InputText
                                    id="slug"
                                    v-model="form.slug"
                                    class="mt-2 block w-full"
                            ...
                            <div>
                                <InputLabel for="category" value="Category label (for filters)" />
                                <InputText
                                    id="category"
