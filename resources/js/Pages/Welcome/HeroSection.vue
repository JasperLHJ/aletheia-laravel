...
<template>
    ...
    >
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="hero-eyebrow flex items-center gap-3 mb-6">
                        ...
                        <p class="text-xs font-sans font-semibold uppercase tracking-[0.22em] text-gold/80" aria-hidden="true">
                            Welcome to Aletheia Resource Center
                        </p>
                    </div>
                    ...
                    <h1 id="hero-heading" class="hero-title font-display font-bold text-neutral-50 leading-[1.08] mb-7" style="font-size: clamp(2.6rem, 5.5vw, 4rem);">
                        <span class="hero-title-line-1 block overflow-hidden">
                            <span class="block">Shaping minds.</span>
                        </span>
                        <span class="hero-title-line-2 block overflow-hidden">
                            <em class="block text-gold not-italic">Inspiring futures.</em>
                        </span>
                    </h1>

                    <p class="hero-subtitle text-white/65 leading-relaxed max-w-[480px] mb-10" style="font-size: clamp(1rem, 1.8vw, 1.1rem);">
                        A tradition of academic excellence, nurturing students who think boldly and act with integrity.
                        <strong class="text-white/80 font-medium">Enrolment now open for 2026.</strong>
                    </p>
                    ...
                    <div class="hero-ctas flex flex-wrap gap-3 items-center mb-8">
                        ...
                        <a
                            href="https://wa.me/60312345678?text=Hi%2C%20I%27d%20like%20to%20find%20out%20more%20about%20Aletheia%20Resource%20Center."
                            target="_blank"
                        ...
                        <!-- Email -->
                        <a
                            href="mailto:hello@aletheia.edu.my?subject=Enquiry%20about%20Aletheia%20Resource%20Center"
                            class="hero-btn-ghost group"
                            aria-label="Email us an enquiry"
                        >
                    ...
                    <div class="hero-badges flex items-center gap-4">
                        <span class="text-[11px] font-sans font-medium uppercase tracking-widest text-white/30">Follow us</span>
                        <a
                ...
                <div class="hero-image-wrap hidden lg:flex flex-col gap-5 items-end">
                    ...
                    <div class="relative">
                        ...
                        >
                            <img
                                src="/images/student-1.jpg"
                                alt="Students at Aletheia Resource Center"
                        ...
                        <div
                            class="hero-stat absolute -left-16 top-8 hero-stat-chip"
                        >
                            <span class="hero-stat-value">15+</span>
                            <span class="hero-stat-label">Years of<br>Excellence</span>
                        </div>
                        <div
                            class="hero-stat absolute -left-14 bottom-16 hero-stat-chip"
                        >
                            <span class="hero-stat-value">98%</span>
                            <span class="hero-stat-label">Graduate<br>Satisfaction</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div
            ...
            aria-hidden="true"
        >
            <span class="text-[10px] font-sans font-medium tracking-[0.2em] uppercase">Scroll</span>
